...
root.geometry("1100x700+600+500")
...
def getweather():
    try:
        ...
        # weather
        api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=1d0676dff572b9f8b35ebeecf85478c4"
...
# Bottom box
Frame_image = PhotoImage(file="minus.png")
frame_myimage = Label(image=Frame_image)
frame_myimage.place(x=95, y=460)
